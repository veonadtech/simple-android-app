 ...
 */
public class AuctionBannerEventHandler implements BannerEventHandler, GamAdEventListener {

    private static final String TAG = AuctionBannerEventHandler.class.getSimpleName();
    ...
    public void setAuctionEventListener(
            @NonNull
