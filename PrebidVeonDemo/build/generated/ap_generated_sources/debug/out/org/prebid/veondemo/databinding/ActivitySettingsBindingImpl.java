...
public class ActivitySettingsBindingImpl extends ActivitySettingsBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tvFuture, 1);
        sViewsWithIds.put(R.id.groupSettings, 2);
        sViewsWithIds.put(R.id.autoRefreshRow, 3);
        sViewsWithIds.put(R.id.autoRefreshText, 4);
        sViewsWithIds.put(R.id.et_refresh_time, 5);
        sViewsWithIds.put(R.id.tvError, 6);
    }
    // views
    @NonNull
